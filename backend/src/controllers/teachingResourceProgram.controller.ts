...
const MATRIKS_WEEK_COLUMNS: TeachingResourceSectionSchema['columns'] = Array.from({ length: 19 }, (_, index) => ({
  ...
  dataType: 'BOOLEAN',
  headerGroupKey: 'pelaksanaan_minggu_ke',
  headerGroupLabel: 'Pelaksanaan Minggu Ke-',
  semanticKey: `minggu_${index + 1}`,
  fieldIdentity: `minggu_${index + 1}`,
  sourceType: 'MANUAL',
  valueSource: 'MANUAL',
...
const PROGRAM_SCHEMA_KKTP: TeachingResourceProgramSchema = {
  ...
  sections: [
    ...
    },
    {
      ...
      sectionTitleEditable: false,
      columns: [
        { key: 'no', label: 'NO.', placeholder: '1', semanticKey: 'no', fieldIdentity: 'no' },
        {
          key: 'tujuan_pembelajaran',
          label: 'Tujuan Pembelajaran (TP)',
          placeholder: 'Pilih TP dari ATP/Prota',
          multiline: true,
        ...
        },
        {
          ...
          placeholder: '✓',
          multiline: true,
          headerGroupKey: 'kriteria_penetapan_kktp',
          headerGroupLabel: 'Kriteria Penetapan KKTP',
        },
        {
          key: 'memadai',
          label: 'Memadai',
    ...
    },
    {
      ...
      columns: [
        { key: 'no', label: 'No', placeholder: '1', semanticKey: 'no', fieldIdentity: 'no' },
        {
          ...
          placeholder: 'Pilih TP dari Prota',
          multiline: true,
          semanticKey: 'tujuan_pembelajaran',
          fieldIdentity: 'tujuan_pembelajaran',
          sourceType: 'DOCUMENT_REFERENCE',
        ...
        },
        {
          ...
          binding: {
            sourceProgramCode: 'PROTA',
            sourceFieldIdentity: 'semester',
            sourceDocumentFieldIdentity: 'semester',
            filterByContext: true,
            matchBySubject: true,
            matchByClassLevel: true,
            matchByMajor: true,
