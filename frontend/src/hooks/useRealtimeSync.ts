...
const STAFF_FINANCE_QUERY_PREFIXES = [
  'staff-finance-bank-accounts',
  'staff-finance-bank-reconciliations',
  'staff-finance-payment-verifications',
  'staff-finance-ledger-books',
  'staff-finance-components',
  'staff-finance-tariffs',
  'staff-finance-adjustments',
  'staff-finance-invoices',
  'staff-finance-credits',
  'staff-finance-cash-sessions',
  'staff-finance-write-offs',
  'staff-finance-payment-reversals',
  'staff-finance-reminder-policy',
  'staff-finance-cash-session-policy',
  'staff-finance-closing-periods',
  'staff-finance-closing-period-reopen-requests',
  'staff-finance-closing-period-policy',
  'staff-finance-budget-realization',
  'staff-finance-performance-summary',
  'staff-finance-integrity-summary',
  'staff-finance-reports',
];
const HEAD_TU_FINANCE_QUERY_PREFIXES = [
  'head-tu-finance-snapshot',
  'head-tu-finance-write-offs',
  'head-tu-finance-payment-reversals',
  'head-tu-finance-cash-sessions',
  'head-tu-finance-cash-session-approvals',
  'head-tu-finance-bank-reconciliations',
  'head-tu-finance-budget-realization',
  'head-tu-finance-governance',
  'head-tu-finance-audit',
  'head-tu-finance-performance',
  'head-tu-finance-integrity',
  'head-tu-finance-closing-periods',
  'head-tu-finance-closing-period-approvals',
  'head-tu-finance-closing-period-reopen-requests',
  'head-tu-finance-closing-period-reopen-approvals',
];
