                    ...
                    >
                      ...
                      <div className="relative border-b border-gray-200 px-3 py-2.5">
                        <div className="mx-auto flex max-w-[438px] justify-center text-center">
                          <div className="inline-flex max-w-[376px] items-center gap-[38px] md:max-w-[400px] md:gap-[38px]">
                            ...
                            <div className="min-w-0 max-w-[266px] text-center leading-tight md:max-w-[290px]">
