          ...
          <div className="flex gap-2">
             <button 
               ...
               className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                 activeTab === 'editor' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border border-gray-200'
               }`}
             >
             ...
             <button 
               ...
               className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                 activeTab === 'preview' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border border-gray-200'
               }`}
             >
               <FileText size={16} className="inline mr-2" /> Preview Dokumen ({documentRows.length})
             </button>
          </div>
        </div>
      </div>
