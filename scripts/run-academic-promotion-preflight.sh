...
Options:
  ...
  --with-smoke-test    Jalankan smoke test clone DB promotion + histori report + histori absensi + histori izin/BP-BK setelah audit utama.
...
if [ "$WITH_SMOKE_TEST" -eq 1 ]; then
  ...
  echo "-> Menjalankan smoke test histori izin/BP-BK pasca-promotion"
