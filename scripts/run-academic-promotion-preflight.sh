...
Options:
  ...
  --with-smoke-test    Jalankan smoke test clone DB promotion + histori report + histori absensi + histori izin/BP-BK/TU + histori PKL + histori finance + refund backfill setelah audit utama.
